...
public class OrderDish extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //additem = (TextView) findViewById(R.id.number_btn);
        ...
        dataaa.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                additem.setOnClickListener(new TextView.OnClickListener() {
                    @Override
                                    ...
                                    if (ChefID.equals(cart1.getChefId())) {
                                        ...
                                        data.addListenerForSingleValueEvent(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                ...
                                                int num = Integer.parseInt(additem.getFontFeatureSettings());
